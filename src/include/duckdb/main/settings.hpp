...
struct DisableJsonValidationSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "disable_json_validation";
	static constexpr const char *Description = "Disable JSON validation for VARCHAR to JSON casts.";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_ONLY;
...
struct DisableParquetJsonValidationSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "disable_parquet_json_validation";
	static constexpr const char *Description = "Disable JSON validation for JSON logical types read from Parquet.";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_ONLY;
...
struct DisableParquetUtf8ValidationSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "disable_parquet_utf8_validation";
	static constexpr const char *Description = "Disable UTF-8 validation for VARCHAR columns read from Parquet.";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_ONLY;
